...
public:
    int earliestFinishTime(vector<int>& landStartTime, vector<int>& landDuration, vector<int>& waterStartTime, vector<int>& waterDuration) {
        ...
        // looping through every combimnation of land ride i and water ride j
        for (int i = 0; i < n; ++i) {
            for (int j = 0; j < m; ++j) {
                ...
                // Track the earliest finish time overall
                minFinishTime = min({minFinishTime, finalFinish1, finalFinish2});
            }
        }
